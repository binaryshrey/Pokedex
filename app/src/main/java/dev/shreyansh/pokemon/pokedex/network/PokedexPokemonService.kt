...
private const val POKEMON_BASE_URL = "https://raw.githubusercontent.com/binaryshrey/Pokedex-APP/main/pokedex-api/data-source/"
...
interface PokedexPokemonService {
    ...
    @GET("pokemons.json")
    suspend fun getAllPokeMons(): List<PokemonResponse>
